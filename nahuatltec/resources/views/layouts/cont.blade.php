        ...
        @else
                ...
                <header>
                        <div class="header-content">
                            ...
                            <div class="menu" id="show-menu">
                                <nav>
                                    <ul>
                                        <li><a href="{{ app('router')->has('home') ? route('home') : url('/') }}"> <i class="fas fa-headset"></i><span class="icon-home"></span> Inicio</a></li>
                                        <li><a href="{{ route('login.index')}}"> <i class="fas fa-headset"></i> Ingresa</a></li>
                                        <li><a href="{{ route('register.index')}}"> <i class="fas fa-headset"></i> Registrate</a></li>
                                        <li class="menu-selected"><a href="{{ route('contact.index')}}" class="text-menu-selected"> 
                                        <i class="fas fa-file-alt"></i>Contactanos</a></li>
                                    </ul>
                                </nav>
                            </div>
                ...
                <div id="ctn-bars-search">
                    <input type="text" id="inputSearch" placeholder="¿Qué deseas buscar?">
                        ...
                        <ul id="box-search">
                            <li><a href="{{ route('login.index')}}"><i class="fas fa-search"></i>Error 404</a></li>
