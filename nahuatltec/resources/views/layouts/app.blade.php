                ...
                <header>
                        <div class="header-content">
                            ...
                            <div class="menu" id="show-menu">
                                <nav>
                                    <ul>
                                        <li class="menu-selected"><a href="{{ app('router')->has('home') ? route('home') : url('/') }}" class="text-menu-selected"> 
                                        <i class="fas fa-file-alt"></i><span class="icon-home"></span> Inicio</a></li>
